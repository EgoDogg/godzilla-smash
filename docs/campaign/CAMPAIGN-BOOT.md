...
- 2026-06-13 · campaign bootstrap · anchor `3a81b40` — durable state scaffolded; resume point = UR (research-lock).

## RESUME ANCHOR (next concrete action)
**Resume point = UR (research-lock).** Nothing shipped yet. Run the UR dynamic workflow → `docs/research-2026-06.md` with the ≥97% balance + touch numbers, commit, then begin U1. Cache still at gz-v13.
