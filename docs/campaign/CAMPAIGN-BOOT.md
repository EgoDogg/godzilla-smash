...
**Resume point = UE1 (bounded economy, the gz-v16 headline). v15 is LIVE; campaign re-planned to gz-v16→v20 (see roadmap doc + the changelog entry above).** Full sequence in campaign-progress.json `_run_policy.sequence` (authoritative); per-unit specs in the JSON notes + docs/campaign-roadmap-v16plus.md + research-2026-06b/06c.md + visual-redesign-plan.md.
