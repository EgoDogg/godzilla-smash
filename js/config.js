...
window.GAME.Config = {
  ...
  SMASH: {
    ...
    COST_K: 14   // cost = COST_K × the power the next rung grants × formMult — the pacing dial.
  ...
  MOVESPD: { PER_LEVEL: 0.08, LEVELS: 6, COSTS: [45, 85, 160, 300, 560, 1050] },
  ...
  WORLD2_COST: 2500,         // capstone unlock → "Coming soon" stub (W0.1: 12e9 → 2500)
  ...
  FORMS: [
    ...
    { id: 'burning', name: 'Burning Godzilla', label: '2019', family: 'wyrm', archetype: 'wyrm', tier: 1, base: 48, cost: 72,
      palette: {
    ...
    { id: 'gvk', name: 'Godzilla · GvK', label: '2021', family: 'wyrm', archetype: 'wyrm', tier: 2, base: 240, cost: 86,
      palette: {
    ...
    { id: 'gxk', name: 'Godzilla × Kong', label: '2024', family: 'wyrm', archetype: 'wyrm', tier: 3, base: 3000, cost: 100,
      palette: {
    ...
    { id: 'supernova', name: 'Supernova Godzilla', label: '2027', family: 'wyrm', archetype: 'wyrm', tier: 4, base: 18000, cost: 120,
      palette: {
    ...
    { id: 'mothra_gvm', name: 'Mothra', label: 'GvM', family: 'mothra', archetype: 'flyer', tier: 5, base: 1500000, cost: 150,
      palette: {
    ...
    { id: 'mothra_gxk', name: 'Mothra', label: 'GxK', family: 'mothra', archetype: 'flyer', tier: 6, base: 3000000, cost: 180,
      palette: {
      ...
      attack: { kind: 'cloud', cooldown: 0.46, dot: { frac: 0.06, ticks: 10, intervalMs: 300 } } },
    { id: 'mothra_supernova', name: 'Mothra', label: 'Supernova', family: 'mothra', archetype: 'flyer', tier: 7, base: 7600000, cost: 210,
      palette: {
    ...
    { id: 'ghidorah', name: 'King Ghidorah', label: 'T1', family: 'ghidorah', archetype: 'hydra', tier: 8, base: 350000, cost: 250,
      palette: {
    ...
    { id: 'king_ghidorah', name: 'King Ghidorah', label: 'T2', family: 'ghidorah', archetype: 'hydra', tier: 9, base: 750000, cost: 300,
      palette: {
      ...
      attack: { kind: 'bolts', hits: 3, cooldown: 0.5, color: 'eye' } },
    { id: 'mecha_ghidorah', name: 'Mecha King Ghidorah', label: 'T3', family: 'ghidorah', archetype: 'hydra', tier: 10, base: 900000, cost: 360,
      palette: {
      ...
      attack: { kind: 'bolts', hits: 3, cooldown: 0.5, color: 'eye' } },
    { id: 'grand_king', name: 'Grand King Ghidorah', label: 'T4', family: 'ghidorah', archetype: 'hydra', tier: 11, base: 1200000, cost: 430,
      palette: {
      ...
      attack: { kind: 'bolts', hits: 3, cooldown: 0.5, color: 'eye' } },
    { id: 'void_ghidorah', name: 'Void Ghidorah', label: 'T5', family: 'ghidorah', archetype: 'hydra', tier: 12, base: 2600000, cost: 510,
      palette: {
    ...
    { id: 'rodan', name: 'Rodan', label: 'T1', family: 'rodan', archetype: 'flyer', tier: 13, base: 4000000, cost: 620,
      palette: {
    ...
    { id: 'rodan_mv', name: 'Rodan', label: 'MV', family: 'rodan', archetype: 'flyer', tier: 14, base: 6500000, cost: 740,
      palette: {
    ...
    { id: 'rodan_fire', name: 'Rodan', label: 'Fire', family: 'rodan', archetype: 'flyer', tier: 15, base: 12000000, cost: 880,
      palette: {
    ...
    { id: 'mecha_1', name: 'Mechagodzilla', label: 'T1', family: 'mecha', archetype: 'mecha', tier: 16, base: 9000000, cost: 1100,
      palette: {
    ...
    { id: 'mecha_2', name: 'Mechagodzilla', label: 'T2', family: 'mecha', archetype: 'mecha', tier: 17, base: 13900000, cost: 1300,
      palette: {
      ...
      attack: { kind: 'volley', hits: 5, cooldown: 0.42 } },
    { id: 'mecha_3', name: 'Mechagodzilla', label: 'T3', family: 'mecha', archetype: 'mecha', tier: 18, base: 15000000, cost: 1500,
      palette: {
    ...
    { id: 'super_mecha', name: 'Mechagodzilla', label: 'Super', family: 'mecha', archetype: 'mecha', tier: 19, base: 16800000, cost: 1800,
      palette: {
